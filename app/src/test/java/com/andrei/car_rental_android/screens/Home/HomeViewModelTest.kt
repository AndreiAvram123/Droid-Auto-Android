...
class HomeViewModelTest : BaseViewModelTest() {
    ...
    @Test
    fun `When there is an ongoing ride, the navigation state will be Navigate to Ride Screen`() = runDroidAutoTest{
        returnSuccess {
        ...
        sut.navigationState.test {
            sut.checkForReservationOrRide()
            assert(awaitItem() is HomeNavigator.HomeNavigationState.Default)
            assert(awaitItem() is HomeNavigator.HomeNavigationState.NavigateToRideScreen)
        }
    }
